...
while True:
    ...
    for tr in tracks:
        ...
        if tid not in person_db_state:
            ...
            person_db_state[tid].update({"looking_frames":0,"total_frames":0,"engaged":False})
        ...
        cv2.putText(frame,f"ID {tid}  | mv:{motion:.1f} | {label}",(x1,y1-10),
    ...
    cv2.putText(frame,f"FPS:{fps:.1f} | Active:{active_tracks}",(10,30),
